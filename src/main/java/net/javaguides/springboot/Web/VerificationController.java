...
public class VerificationController {
    ...
    @GetMapping
    public String showVerificationForm(Model model, HttpSession session) {
        ...
        System.out.println(model.getAttribute("verificationCode"));
        return "verification";
    }
    ...
    public String verifyCode(
        ...
        UserRegistrationDTO registrationDTO = (UserRegistrationDTO) model.getAttribute("user");
        String storedVerificationCode = (String) model.getAttribute("verificationCode");
